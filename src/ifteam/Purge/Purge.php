...
class Purge extends PluginBase implements Listener {
	...
	public function onEnable() {
		...
		// 플러그인의 명령어 등록
		$this->registerCommand ( $this->get ( "fight-request" ), "Purge.fightRequest", $this->get ( "fight-request-description" ), $this->get ( "fight-request-usage" ) );
